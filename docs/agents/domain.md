...
This repo is **single-context**: one `CONTEXT.md` at the root and one shared `docs/adr/`.
...
New ADRs continue the existing numbering — the next one is `0005-`.
...
> _Contradicts ADR-0003 (nub runtime) — but worth reopening because…_
